...
* **config:** operators who relied on the claude->ANTHROPIC_API_KEY inference must add llm_api_key_env = "ANTHROPIC_API_KEY" to [agents].

### Bug Fixes

* **config:** operator-named LLM API-key env var, not provider-inferred ([#53](https://github.com/mountainowl/bubo/issues/53)) ([f83b80d](https://github.com/mountainowl/bubo/commit/f83b80d68cbf6e527d0730e80b8d9986b874fe0e))
