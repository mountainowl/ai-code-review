...
Composes :mod:`llm_reviewer.gitlab` (REST), :mod:`llm_reviewer.mcp`
...
from llm_reviewer import gitlab, mcp
...
class GitLabProvider:
    """:class:`~llm_reviewer.scm.base.ScmProvider` for GitLab merge requests."""
    ...
    def bot_username(self) -> str:
        return os.environ.get("LLM_REVIEWER_GITLAB_USERNAME", "llm-reviewer")
